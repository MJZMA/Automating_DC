...
if __name__ == '__main__':
    ...
    parser.add_argument('--apikey', help='API key for financialmodelingprep.com', default = 'BSVSMWUYU3hK9ADyKF5ktgTpTLEEQ2AX') #default=os.environ.get('APIKEY')
